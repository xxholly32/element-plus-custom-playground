<template>
  ...
  <div v-bind="containerAttrs" :class="containerKls" :style="containerStyle" :role="containerRole"
    ...
    <template v-if="type !== 'textarea'">
      ...
      <div ref="wrapperRef" :class="wrapperKls">
        ...
        <input :id="inputId" ref="input" :class="nsInput.e('inner')" v-bind="attrs" :minlength="minlength"
          ...
          :aria-label="label || ariaLabel" :placeholder="placeholder" :style="inputStyle" :form="form"
          :autofocus="autofocus" @compositionstart="handleCompositionStart" @compositionupdate="handleCompositionUpdate"
    ...
    <!-- textarea -->
    <template v-else>
      <textarea :id="inputId" ref="textarea" :class="nsTextarea.e('inner')" v-bind="attrs" :minlength="minlength"
        :maxlength="maxlength" :tabindex="tabindex" :disabled="inputDisabled" :readonly="readonly"
        :autocomplete="autocomplete" :style="textareaStyle" :aria-label="label || ariaLabel" :placeholder="placeholder"
        :form="form" :autofocus="autofocus" @compositionstart="handleCompositionStart"
